...
public class StationsAroundPolyline
{
    ...
    public void Setup()
    {
        ...
        var _energyPrices = new EnergyPrices(new FileInfo(csvPath), new Random(42));
        ...
        for (var i = 0; i < 4000; i++)
        {
            ...
            _stations.Add((ushort)i, new Station((ushort)i, string.Empty, string.Empty, new Position(lon, lat), null, _energyPrices));
        }
