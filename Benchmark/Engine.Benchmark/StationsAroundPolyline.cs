...
public class StationsAroundPolyline
{
    ...
    public void Setup()
    {
        ...
        _segments = Polyline6ToPoints.DecodePolyline(polyline);
        var journey = new Journey(0, 0, 0, _segments);
    ...
    {
        var stationNearBy = _spatialGrid.GetStationsAlongPolyline(_segments, _ev.Preferences.MaxPathDeviation);
        _ = ReachableStations.FindReachableStations(_segments, _ev, _stations, stationNearBy, _ev.Preferences.MaxPathDeviation);
    }
}
