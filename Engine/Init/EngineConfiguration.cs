...
public static class EngineConfiguration
{
    ...
    public static EngineSettings CreateDefaultSettings()
    {
        ...
        return new EngineSettings
        {
            ...
            {
                PathDeviation = ReadWeightFromEnvironment(_pathDeviationEnvVar, 10f, 0f, 100f, isPythonMode),
                PriceSensitivity = ReadWeightFromEnvironment(_priceSensitivityEnvVar, 1f, 0f, 10f, isPythonMode),
                ExpectedWaitTime = ReadWeightFromEnvironment(_expectedWaitTimeEnvVar, 40f, 0f, 100f, isPythonMode),
            },
            RunId = Guid.NewGuid(),
            ...
            SimulationStartTime = (uint)ReadIntFromEnvironment(_simulationStartTimeEnvVar, (int)Time.MillisecondsPerDay + (int)Time.MillisecondsPerHour * 6, isPythonMode),
            SimulationEndTime = (uint)ReadIntFromEnvironment(_simulationEndTimeEnvVar, (int)Time.MillisecondsPerDay * 2 - (int)Time.MillisecondsPerHour * 6, isPythonMode),
