...
/// </summary>
public readonly struct ReservationSnapshotMetric
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the total number of reservations made across all stations in the last time window.
    /// </summary>
    required public int TotalReservations { get; init; }
}