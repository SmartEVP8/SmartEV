...
public unsafe partial class OSRMRouter : IDisposable, IOSRMRouter
{
    ...
    private const float SecondsToMilliseconds = Time.MillisecondsPerSecond;
        ...
        ushort[] indices)
    {
        ...
        for (var i = 0; i < durations.Length; i++)
            durations[i] *= SecondsToMilliseconds;
        ...
        double destLat)
    {
        ...
        return new RouteSegment(result.Duration * SecondsToMilliseconds, result.Distance, polylineStr);
    }
