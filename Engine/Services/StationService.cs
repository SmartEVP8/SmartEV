...
public class StationService
{
    ...
    public void HandleReservationRequest(ReservationRequest e)
    {
        ...
        _scheduler.ScheduleEvent(
            new ArriveAtStation(e.EVId, e.StationId, ev.ChargeTo(e.Time + e.DurationToStation), e.Time + e.DurationToStation)); //TODO: WE CHARGE TO 80% WE PROBABLY NEED SOMETHING BETTER HERE
    }
