...
public class JourneyTests
{
    ...
    public void JourneyInterpolationEnd()
    {
        ...
        var journey = new Journey(departure: 0, originalDuration: 2, originalDistance: 10, new Paths(waypoints));
    ...
    public void JourneyInterpolationBetweenMultipleLineSegments()
    {
        ...
        var journey = new Journey(departure: 0, originalDuration: 4, originalDistance: 10, new Paths(waypoints));
