...
public class JourneyTests
{
    ...
    public void JourneyInterpolationEnd()
    {
        ...
        var journey = new Journey(departure: 0, duration: 2, distanceMeters: 10, new Segments(waypoints));
    ...
    public void JourneyInterpolationBetweenMultipleLineSegments()
    {
        ...
        var journey = new Journey(departure: 0, duration: 4, distanceMeters: 10, new Segments(waypoints));
