...
public class UrgencyTests
{
    ...
    {
        var ev = CoreTestData.EV(battery: new Battery(capacity: 100, maxChargeRate: 150, stateOfCharge: 0.81f), preferences: new Preferences(priceSensitivity: 0, minAcceptableCharge: 0.2f, maxPathDeviationKm: 0));
    ...
    public void CalculateChargeUrgency_ReturnsOne_WhenStateOfChargeIsAtMinimumAcceptableCharge()
    {
        ...
        Assert.Equal(0.9999, urgency, precision: 4);
    }
}
