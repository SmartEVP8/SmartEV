...
public class ReachableStationsTests
{
    ...
    public void FindReachableStationse()
    {
        ...
        var battery = new Battery(100, 50, 15, Socket.CCS2);
        ...
        {
            new(1, "Station A", "Address A", new Position(0.5, 0.5), null, 0.5f, new Random()),
            new(2, "Station B", "Address B", new Position(2.0, 2.0), null, 0.5f, new Random()),
            new(3, "Station C", "Address C", new Position(0.1, 0.1), null, 0.5f, new Random()),
        };

        var nearbyStations = new List<ushort> { 1, 2, 3 };
        var reachableStations = ReachableStations.FindReachableStations(path, ev, stations, nearbyStations);
