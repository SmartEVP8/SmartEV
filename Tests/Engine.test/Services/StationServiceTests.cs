...
public class StationServiceTests
{
        ...
        int maxPowerKW = 150)
    {
        ...
        var service = new StationService([station], integrator, scheduler, evStore, applyNewPath, metrics, snapshotHandler);
        ...
        int maxPowerKW = 150)
    {
        ...
        var snapshotHandler = SnapshotHandler(metrics, scheduler, [station]);
        var applyNewPath = new ApplyNewPath(TestData.OSRMRouter);
        var service = new StationService([station], integrator, scheduler, evStore, metrics, snapshotHandler, applyNewPath);
